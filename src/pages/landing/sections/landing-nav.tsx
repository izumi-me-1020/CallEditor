...
const LandingNav: React.FC = () => {
  return (
    <header className="px-6 py-5 border-b border-calleditor-border sticky top-0 z-50 bg-calleditor-bg/90 backdrop-blur-md">
      <nav className="max-w-6xl mx-auto flex items-center justify-between gap-6">
        <Link to="/ttml-maker" className="flex items-center gap-2 select-none">
          ...
          <span className="font-semibold text-calleditor-text">CallEditor</span>
        </Link>
        <div className="hidden md:flex items-center gap-6 text-sm text-calleditor-text-secondary">
