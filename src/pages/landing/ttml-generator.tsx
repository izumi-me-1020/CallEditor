  ...
  return (
    <LandingLayout>
      ...
      <Hero
        ...
        subhead="Paste lyrics, load audio, tap along to mark timing, and CallEditor generates a valid TTML file you can download immediately."
