...
const FAQS = [
  ...
  {
    question: "Can CallEditor handle duets and featured artists?",
    answer:
...
const TITLE = "Make Apple Music Synced Lyrics ・ CallEditor";
const DESCRIPTION =
  ...
  return (
    <LandingLayout>
      <PageHead
        ...
        jsonLd={[
          softwareApplicationSchema(
            "CallEditor for Apple Music Synced Lyrics",
            DESCRIPTION,
            PATH,
          ),
          faqPageSchema(FAQS),
      ...
      <Hero
        ...
        subhead="CallEditor handles multi-agent duets, background vocals with x-bg, and word-level timing the way Apple Music ingests it. No XML, no guesswork."
      ...
      <FeatureGrid
        ...
        subtitle="Apple Music has specific TTML requirements. CallEditor meets them by default."
        features={[
          {
            icon: IconBrandApple,
