...
const TITLE = "Free TTML Maker Online ・ CallEditor";
const DESCRIPTION =
  ...
  return (
    <LandingLayout>
      <PageHead
        ...
        path={PATH}
        jsonLd={[
          softwareApplicationSchema("CallEditor TTML Maker", DESCRIPTION, PATH),
          faqPageSchema(FAQS),
          breadcrumbListSchema([
      ...
      <Hero
        ...
        subhead="CallEditor turns an audio file and plain lyrics into a standard TTML file with word-level timing. Tap along to sync, fine tune in the timeline, and export."
      ...
      <FeatureGrid
        ...
        subtitle="CallEditor is built to author the kind of TTML that Apple Music, Spotify, and Better Lyrics actually ship."
        features={[
          {
            icon: IconHandStop,
            title: "Tap to sync",
