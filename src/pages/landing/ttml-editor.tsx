...
const FAQS = [
  ...
  {
    question: "Does CallEditor support undo and history?",
    answer:
  ...
  return (
    <LandingLayout>
      ...
      <FeatureGrid
        ...
        subtitle="Most TTML tools generate and hope. CallEditor lets you edit at the level of a single millisecond."
        features={[
          {
            icon: IconWaveSine,
