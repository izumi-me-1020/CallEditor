...
const TITLE = "Make Spotify Synced Lyrics ・ CallEditor";
const DESCRIPTION =
  ...
  return (
    <LandingLayout>
      <PageHead
        ...
        jsonLd={[
          softwareApplicationSchema(
            "CallEditor for Spotify Synced Lyrics",
            DESCRIPTION,
            PATH,
          ),
          faqPageSchema(FAQS),
      ...
      <Hero
        ...
        subhead="CallEditor produces clean, standards-compliant TTML files ready for Spotify's lyrics pipeline. Tap to sync, adjust against a waveform, export."
        primaryCta={{ label: "Start authoring", to: "/" }}
        secondaryCta={{ label: "What is TTML?", to: "/guides/what-is-ttml" }}
      />
      <FeatureGrid
        title="What you get with CallEditor for Spotify lyrics"
        features={[
          {
