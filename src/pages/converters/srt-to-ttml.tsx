...
const HOW_TO_STEPS = [
  ...
  { name: "Get TTML", text: "TTML output appears on the right as you paste." },
  {
    ...
    text: "Download the TTML or open the project in CallEditor to upgrade to word-level timing.",
  },
];
...
function convertSrt({
  ...
  try {
    ...
    console.error("[CallEditor] SRT conversion failed", conversionError);
    ...
    <LandingLayout>
      ...
      <section className="px-6 py-14 max-w-3xl mx-auto text-calleditor-text-secondary leading-relaxed space-y-5">
        ...
        <p>
          ...
          word-level timing, open it in CallEditor and resync against your
          audio.
        </p>
      </section>
