...
const HOW_TO_STEPS = [
  ...
  },
  {
    ...
    text: "CallEditor produces TTML output on the right as you paste.",
  },
  {
    name: "Download or refine",
    text: "Download the TTML, or open it in CallEditor to refine timing against an audio waveform.",
  },
];
...
function convertLrc({
  ...
  try {
    ...
    console.error("[CallEditor] LRC conversion failed", conversionError);
...
const LrcToTtmlPage: React.FC = () => {
  ...
  return (
    <LandingLayout>
      ...
      />
      <section className="px-6 py-14 max-w-3xl mx-auto text-calleditor-text-secondary leading-relaxed space-y-5">
        <h2 className="text-2xl font-semibold text-calleditor-text">
          About LRC and eLRC
        </h2>
        <p>
