    ...
    <AnimatePresence>
      {state && (
        <m.div
          ...
          className="fixed bottom-6 right-6 z-10001 w-72 rounded-r-xl border border-calleditor-border bg-calleditor-bg-dark p-4 pl-5 shadow-[inset_2px_0_0_0_var(--color-calleditor-accent),0_25px_50px_-12px_rgb(0_0_0/0.25)] select-none"
        >
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-calleditor-text">
                {state.isComplete ? (
