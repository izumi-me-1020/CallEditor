    ...
    >
      <div className="flex flex-col gap-4">
        <div className="text-sm text-calleditor-text-secondary leading-relaxed select-text">
          You changed the word count on a line in <strong>{groupName}</strong>.{" "}
          {affectedSiblingCount} other {siblingNoun} will be affected.
          <br />
          <br />
          <strong>Apply to all</strong> (recommended)
          <br />
          Mirrors the new word structure across every instance. Words that
          didn't actually change keep their existing timing, so per-instance
          rhythms you've already tuned stay intact. Only the split or merged
          word's slot gets re-divided.
          <br />
          <br />
          <strong>Detach</strong>
          <br />
          Keeps the change on this line only and unlinks it from the group.
          Other instances stay exactly as they were.
        </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex gap-2 select-none">
            ...
            <Button
              size="sm"
              onClick={() => close("apply")}
              className="bg-calleditor-accent-dark hover:bg-calleditor-accent text-white"
            >
              Apply to all
            </Button>
          </div>
