...
const COPY = {
  en: {
    intro:
      "CallEditor saves your work as you go. If the app crashes, freezes, or you accidentally close the tab, your lyrics and timing are still there. Here's how to get them back.",
  ...
  ja: {
    intro:
      "CallEditor は作業内容を随時保存しています。クラッシュしたり固まったり、誤ってタブを閉じたりしても、歌詞やタイミングは残っていることがほとんどです。復旧方法は次の通りです。",
    error: "エラー画面が出た",
    errorBody:
    ...
    backupBody:
      "歌詞、タイミング、エージェント、グループ、プロジェクトメタデータです。音声は大きすぎるため含まれないので、自分で再読み込みしてください。データは端末内にだけ保存され、アップロードはされません。",
    missing: "何も出てこない",
    missingBody:
  ...
  ko: {
    intro:
      "CallEditor는 작업 내용을 계속 저장합니다. 앱이 크래시 나거나 멈추거나 실수로 탭을 닫아도 가사와 타이밍이 남아 있는 경우가 많습니다. 복구 방법은 다음과 같습니다.",
    ...
    backup: "백업에 들어가는 내용",
    backupBody:
      "가사, 타이밍, 에이전트, 그룹, 프로젝트 메타데이터가 포함됩니다. 오디오는 용량이 커서 포함되지 않으므로 직접 다시 불러와야 합니다. 모든 데이터는 기기 안에만 남고 업로드되지 않습니다.",
    missing: "아무것도 안 보일 때",
    missingBody:
