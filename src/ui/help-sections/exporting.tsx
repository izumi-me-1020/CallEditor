...
const COPY = {
  en: {
    ...
    project:
      'Use "Export Project" to save a .json file with all your data (calls, timing, agents, metadata). Use "Import Project" to load one back. This is how you share work with collaborators or back things up.',
  ...
  ja: {
    ...
    project:
      '"Export Project" ではコール・タイミング・エージェント・メタデータを含む .json を保存できます。"Import Project" で再読み込みできます。共同作業やバックアップに使います。',
  ...
  ko: {
    ...
    project:
      '"Export Project"는 콜, 타이밍, 에이전트, 메타데이터가 들어 있는 .json 파일을 저장합니다. "Import Project"로 다시 불러올 수 있어 협업이나 백업에 적합합니다.',
