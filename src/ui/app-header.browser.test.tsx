...
describe("AppHeader", () => {
  it("renders the CallEditor logo and brand text", async () => {
    ...
    await expect
      .element(screen.getByRole("img", { name: "CallEditor Logo" }))
      .toBeInTheDocument();
    expect(screen.container.textContent).toContain("CallEditor");
  });
