  ...
  if (keys.length === 0) {
    return (
      <span
        ...
        className="inline-flex items-center justify-center h-4 px-1.5 text-[10px] font-medium rounded bg-white/5 text-calleditor-text-muted leading-none italic ml-1.5"
      >
        Unbound
      </span>
    );
